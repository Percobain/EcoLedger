...
router.post('/:projectId', upload.array('files', 6), submissionsController.createSubmission);
...
router.get('/project/:projectId', submissionsController.getSubmissionsByProject);
