...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section
        className="relative bg-gradient-to-br from-nb-bg to-nb-accent/10 py-20 px-4"
        style={{
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-6">
            Restore Our
            <span className="text-teal-200 block">Blue Planet</span>
          </h1>
          <p className="text-xl md:text-2xl text-white mb-12 max-w-3xl mx-auto font-body">
            ...
            {portalCards.map((card, index) => {
              ...
              return (
                ...
                >
                  <Link to={card.link}>
                    <div
                      className={`w-16 h-16 ${card.color} rounded-nb flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform`}
                    >
                    ...
                    <NBButton
                      variant="ghost"
                      className="group-hover:bg-nb-ink group-hover:text-nb-card"
                    >
                      Get Started
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            ...
            change through verified blue carbon projects.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <NBButton
              variant="primary"
              size="lg"
              className="bg-nb-accent text-nb-card hover:bg-nb-accent/90"
            >
            ...
            <NBButton
              variant="secondary"
              size="lg"
              className="bg-nb-card text-nb-ink hover:bg-nb-card/90"
            >
              <Link to="/csr">Explore Funding</Link>
            </NBButton>
          </div>
