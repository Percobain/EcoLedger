...
const TimelineNode = ({ data, selected, isAnimating, animationIndex }) => {
  ...
  return (
    <div
      ...
      className={`relative px-5 py-4 shadow-lg rounded-nb border-2 transition-all duration-300 hover:scale-105 hover:shadow-xl ${getStatusColor(
        data.status
      )} ${
        selected ? "ring-2 ring-nb-accent ring-offset-2" : ""
...
const ProjectDetails = () => {
  ...
  const createTimelineFlow = useCallback(
    (progressData) => {
      setIsAnimating(true);
  ...
  const convertSubmissionsToProgress = (submissions) => {
    ...
    return submissions.map((submission, index) => {
      ...
      const verifiedDate = submission.verifiedAt
        ? new Date(submission.verifiedAt).toLocaleDateString("en-CA")
        : null;
      ...
      return {
        ...
        description: `${
          status === "completed"
            ...
            ? "Under review"
            : "Submitted"
        } progress report with trust score: ${submission.trustScore || "N/A"}${
          submission.flags && submission.flags.length > 0
            ? ` (${submission.flags.length} flags)`
            : ""
        }`,
    ...
    return [
      {
        ...
        status: "completed",
        description:
          "Site survey completed, soil testing done, and preparation work finished.",
        images: [
      ...
      },
      {
        ...
        status: "in_progress",
        description:
          "Second batch of 3,000 saplings being planted. 60% complete.",
        images: [
      ...
      },
      {
        ...
        status: "pending",
        description:
          "Installation of monitoring equipment and irrigation systems.",
        images: [],
      },
    ];
  };
  ...
  useEffect(() => {
    const loadProject = async () => {
      try {
        ...
        const userProjects = await web3Service.getUserProjects(
        ...
        if (foundProject.metadataUri) {
          try {
            const ipfsUrl = foundProject.metadataUri.replace(
              "ipfs://",
        ...
        const enhancedProject = {
          ...
          description:
            ...
            "This blue carbon restoration project focuses on rehabilitating coastal ecosystems through strategic mangrove plantation and conservation efforts. The initiative aims to enhance biodiversity, protect coastal communities from erosion, and contribute significantly to carbon sequestration goals.",
          projectType: "Blue Carbon Restoration",
          ecosystem:
            metadata?.about_project?.ecosystem ||
            metadata?.project_details?.ecosystem ||
            (metadata?.project_details?.species_planted?.includes("Rhizophora")
              ? "Mangrove Forest"
              : "Coastal Wetland"),
          startDate:
          ...
          communityImpact:
            ...
            "High",
          verificationStatus: foundProject.isValidated
            ? "Verified by NCCR"
            : "Under Review",
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <h3 className="font-display font-bold text-lg text-nb-ink">
                    Submitted by {project.ngo?.slice(0, 6)}...
                    {project.ngo?.slice(-4)}
                  </h3>
                  <div className="flex items-center text-sm text-nb-ink/70">
              ...
              <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">
                            ...
                            {project.metadata?.project_details
                              ?.species_planted || "Native species"}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Leaf className="w-4 h-4 text-nb-ink/60" />
                          <span className="text-sm">
                            <strong>Target Plants:</strong>{" "}
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">
                            <strong>Total Area:</strong> {project.totalArea}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">
                            <strong>Ecosystem:</strong> {project.ecosystem}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Leaf className="w-4 h-4 text-nb-ink/60" />
                          <span className="text-sm">
                            <strong>Carbon Capture:</strong>{" "}
                            {project.estimatedCarbonCapture}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2">
                ...
                {activeTab === "progress" && (
                  <div>
                      ...
                      <div className="flex justify-between text-xs text-nb-ink/60 mt-2">
                        <span className="flex items-center space-x-1">
                          ...
                          <span>
                            ...
                            of {project.progress.length} stages completed
                          </span>
                        </span>
                        <span className="flex items-center space-x-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            <div className="space-y-3">
                              <div>
                                <span className="text-sm font-medium text-nb-ink/70">
                                  Date:
                                </span>
                                <span className="ml-2 text-sm text-nb-ink">
                                  {selectedStage.date}
                                </span>
                              </div>
                              <div>
                                ...
                                <span className="ml-2 text-sm text-nb-ink capitalize">
                              ...
                              <div>
                                ...
                                <p className="mt-1 text-sm text-nb-ink/80 leading-relaxed">
                              ...
                              {selectedStage.submissionId && (
                                <>
                                  <div>
                                    ...
                                    <span className="ml-2 text-xs font-mono text-nb-ink">
                                      {selectedStage.submissionId}
                                    </span>
                                  </div>
                                        ...
                                        <div className="w-20 bg-gray-200 rounded-full h-2">
                                          <div
                                            className={`h-2 rounded-full ${
                                              selectedStage.trustScore > 80
                                                ? "bg-green-500"
                                                : selectedStage.trustScore > 60
                                                ? "bg-yellow-500"
                                                : "bg-red-500"
                                            }`}
                                            style={{
                                              width: `${selectedStage.trustScore}%`,
                                            }}
                                          ></div>
                                        </div>
                                        <span className="text-sm font-medium text-nb-ink">
                                  ...
                                  {selectedStage.flags &&
                                    selectedStage.flags.length > 0 && (
                                      <div>
                                        <span className="text-sm font-medium text-nb-ink/70">
                                          Flags:
                                        </span>
                                        <div className="flex flex-wrap gap-1 mt-1">
                                          {selectedStage.flags.map(
                                            (flag, flagIndex) => (
                                              <span
                                                key={flagIndex}
                          ...
                          {selectedStage.images &&
                            selectedStage.images.length > 0 && (
                              <div>
                                <span className="text-sm font-medium text-nb-ink/70 mb-2 block">
                                  Progress Images:
                                </span>
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-nb p-4 mb-6">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-blue-700">
                            Click on any stage in the timeline above to view
                    ...
                    <div className="space-y-4">
                      <h4 className="font-display font-semibold text-md text-nb-ink">
                        Detailed Progress
                      </h4>
                      {project.progress.map((stage, index) => (
                        ...
                        >
                          <div className="flex items-center justify-between mb-3">
                            <h5 className="font-semibold text-nb-ink">
                              {stage.stage}
                            </h5>
                            <div className="flex items-center space-x-2">
                    ...
                    {submissions.length > 0 ? (
                      <div className="space-y-4">
                        {submissions.map((submission, index) => (
                          <div
                            key={submission.id}
                            className="border border-nb-ink/20 rounded-nb p-6 bg-white"
                          >
                            <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center space-x-2 mt-1">
                                    <div className="w-full bg-gray-200 rounded-full h-2">
                                      <div
                                        className={`h-2 rounded-full ${
                                          (submission.trustScore || 0) > 80
                                            ? "bg-green-500"
                                            : (submission.trustScore || 0) > 60
                                            ? "bg-yellow-500"
                                            : "bg-red-500"
                                        }`}
                                        style={{
                                          width: `${
                                            submission.trustScore || 0
                                          }%`,
                                        }}
                                      ></div>
                                    </div>
                              ...
                              {submission.ngoUpload &&
                                submission.ngoUpload.length > 0 && (
                                  <div>
                                    <span className="text-sm font-medium text-nb-ink/70 mb-2 block">
                                      Uploaded Images (
                                      {submission.ngoUpload.length}):
                                    </span>
                                    <div className="grid grid-cols-3 gap-2">
                                      ...
                                      {submission.ngoUpload.length > 6 && (
                                        <div className="w-full h-16 bg-gray-100 rounded border border-nb-ink/20 flex items-center justify-center">
                                          <span className="text-xs text-nb-ink/70">
                                            +{submission.ngoUpload.length - 6}
                                          </span>
                                        </div>
                                      )}
                      ...
                      <div className="text-center py-12">
                        ...
                        <p className="text-nb-ink/70">
                          Project submissions will appear here once uploaded by
                          the NGO.
                        </p>
                      </div>
                    )}
                    ...
                    {project.documents.length > 0 ? (
                      <div className="space-y-3">
                        {project.documents.map((doc, index) => (
                          <div
                            key={index}
                            className="border border-nb-ink/20 rounded-nb p-4 flex items-center justify-between"
                          >
                            <div className="flex items-center space-x-3">
                              <FileText className="w-8 h-8 text-nb-accent" />
                              <div>
                                <h4 className="font-medium text-nb-ink">
                                  {doc.name}
                                </h4>
            ...
            <NBCard>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-mono text-nb-ink">
                    #{project.nftTokenId}
                  </span>
                </div>
                <div className="flex items-center justify-between">
